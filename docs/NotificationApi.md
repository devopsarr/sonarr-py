...
with sonarr.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr.NotificationApi(api_client)
    force_save = False # bool |  (optional) (default to False)
    notification_resource = sonarr.NotificationResource() # NotificationResource |  (optional)
...
with sonarr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sonarr.NotificationApi(api_client)
    notification_bulk_resource = sonarr.NotificationBulkResource() # NotificationBulkResource |  (optional)
