...
[**delete_metadata_bulk**](MetadataApi.md#delete_metadata_bulk) | **DELETE** /api/v3/metadata/bulk | 
...
[**put_metadata_bulk**](MetadataApi.md#put_metadata_bulk) | **PUT** /api/v3/metadata/bulk | 
...
# **delete_metadata_bulk**
> delete_metadata_bulk(metadata_bulk_resource=metadata_bulk_resource)
...
with sonarr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sonarr.MetadataApi(api_client)
    metadata_bulk_resource = sonarr.MetadataBulkResource() # MetadataBulkResource |  (optional)

    try:
        api_instance.delete_metadata_bulk(metadata_bulk_resource=metadata_bulk_resource)
    except Exception as e:
        print("Exception when calling MetadataApi->delete_metadata_bulk: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **metadata_bulk_resource** | [**MetadataBulkResource**](MetadataBulkResource.md)|  | [optional] 
...
# **put_metadata_bulk**
> MetadataResource put_metadata_bulk(metadata_bulk_resource=metadata_bulk_resource)
...
with sonarr.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.put_metadata_bulk(metadata_bulk_resource=metadata_bulk_resource)
        print("The response of MetadataApi->put_metadata_bulk:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MetadataApi->put_metadata_bulk: %s\n" % e)
```
