...
import sonarr.models
from sonarr import rest
from sonarr.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'sonarr-py/v0.10.0'
    ...
    def __call_api(
        ...
        # fix response type in case of wrong documented 200
        if response_type == None and 299>response_data.status>199:
            response_type = response_types_map.get("200", None)
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sonarr.models, klass)
