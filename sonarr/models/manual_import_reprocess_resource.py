...
class ManualImportReprocessResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "path", "seriesId", "seasonNumber", "episodes", "episodeIds", "quality", "languages", "releaseGroup", "downloadId", "customFormats", "customFormatScore", "indexerFlags", "releaseType", "rejections"]
