...
class ImportListResource(BaseModel):
    ...
    should_monitor: Optional[MonitorTypes] = Field(default=None, alias="shouldMonitor")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "enableAutomaticAdd", "searchForMissingEpisodes", "shouldMonitor", "monitorNewItems", "rootFolderPath", "qualityProfileId", "seriesType", "seasonFolder", "listType", "listOrder", "minRefreshInterval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shouldMonitor": obj.get("shouldMonitor"),
