...
class EpisodeFileListResource(BaseModel):
    ...
    """
    episode_file_ids: Optional[List]
    languages: Optional[List]
    quality: Optional[QualityModel]
    scene_name: Optional[str]
    release_group: Optional[str]
    __properties = ["episodeFileIds", "languages", "quality", "sceneName", "releaseGroup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EpisodeFileListResource:
    ...
    def to_dict(self):
        ...
        if self.episode_file_ids is None:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EpisodeFileListResource:
        """Create an instance of EpisodeFileListResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EpisodeFileListResource.parse_obj(obj)

        _obj = EpisodeFileListResource.parse_obj({
            "episode_file_ids": obj.get("episodeFileIds"),
