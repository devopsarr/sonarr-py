...
class SeriesStatisticsResource(BaseModel):
    ...
    """ # noqa: E501
    season_count: Optional[StrictInt] = Field(default=None, alias="seasonCount")
    ...
    __properties: ClassVar[List[str]] = ["seasonCount", "episodeFileCount", "episodeCount", "totalEpisodeCount", "sizeOnDisk", "releaseGroups", "percentOfEpisodes"]
