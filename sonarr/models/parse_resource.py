...
class ParseResource(BaseModel):
    ...
    parsed_episode_info: Optional[ParsedEpisodeInfo] = Field(default=None, alias="parsedEpisodeInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "parsedEpisodeInfo": ParsedEpisodeInfo.from_dict(obj["parsedEpisodeInfo"]) if obj.get("parsedEpisodeInfo") is not None else None,
