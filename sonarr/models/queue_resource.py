...
class QueueResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "seriesId", "episodeId", "seasonNumber", "series", "episode", "languages", "quality", "customFormats", "customFormatScore", "size", "title", "estimatedCompletionTime", "added", "status", "trackedDownloadStatus", "trackedDownloadState", "statusMessages", "errorMessage", "downloadId", "protocol", "downloadClient", "downloadClientHasPostImportCategory", "indexer", "outputPath", "episodeHasFile", "sizeleft", "timeleft"]
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.status_messages:
            for _item_status_messages in self.status_messages:
                _items.append(_item_status_messages.to_dict() if _item_status_messages is not None else None)
