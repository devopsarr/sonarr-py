...
class EpisodeResourcePagingResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EpisodeResourcePagingResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EpisodeResourcePagingResource:
        """Create an instance of EpisodeResourcePagingResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EpisodeResourcePagingResource.parse_obj(obj)

        _obj = EpisodeResourcePagingResource.parse_obj({
            "page": obj.get("page"),
            ...
            "records": [EpisodeResource.from_dict(_item) for _item in obj.get("records")] if obj.get("records") is not None else None
        })
        return _obj
