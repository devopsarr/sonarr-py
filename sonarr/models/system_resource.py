...
class SystemResource(BaseModel):
    ...
    sqlite_version: Optional[StrictStr] = Field(default=None, alias="sqliteVersion")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sqlite_version (nullable) is None
        # and model_fields_set contains the field
        if self.sqlite_version is None and "sqlite_version" in self.model_fields_set:
            _dict['sqliteVersion'] = None
        ...
        # and model_fields_set contains the field
        if self.database_version is None and "database_version" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sqliteVersion": obj.get("sqliteVersion"),
