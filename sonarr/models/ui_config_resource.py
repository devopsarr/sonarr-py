...
class UiConfigResource(BaseModel):
    ...
    __properties = ["id", "firstDayOfWeek", "calendarWeekColumnHeader", "shortDateFormat", "longDateFormat", "timeFormat", "showRelativeDates", "enableColorImpairedMode", "theme", "uiLanguage"]
