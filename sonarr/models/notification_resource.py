...
class NotificationResource(BaseModel):
    ...
    on_import_complete: Optional[StrictBool] = Field(default=None, alias="onImportComplete")
    on_rename: Optional[StrictBool] = Field(default=None, alias="onRename")
    on_series_add: Optional[StrictBool] = Field(default=None, alias="onSeriesAdd")
    on_series_delete: Optional[StrictBool] = Field(default=None, alias="onSeriesDelete")
    on_episode_file_delete: Optional[StrictBool] = Field(default=None, alias="onEpisodeFileDelete")
    on_episode_file_delete_for_upgrade: Optional[StrictBool] = Field(default=None, alias="onEpisodeFileDeleteForUpgrade")
    ...
    supports_on_import_complete: Optional[StrictBool] = Field(default=None, alias="supportsOnImportComplete")
    supports_on_rename: Optional[StrictBool] = Field(default=None, alias="supportsOnRename")
    supports_on_series_add: Optional[StrictBool] = Field(default=None, alias="supportsOnSeriesAdd")
    supports_on_series_delete: Optional[StrictBool] = Field(default=None, alias="supportsOnSeriesDelete")
    supports_on_episode_file_delete: Optional[StrictBool] = Field(default=None, alias="supportsOnEpisodeFileDelete")
    supports_on_episode_file_delete_for_upgrade: Optional[StrictBool] = Field(default=None, alias="supportsOnEpisodeFileDeleteForUpgrade")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "link", "onGrab", "onDownload", "onUpgrade", "onImportComplete", "onRename", "onSeriesAdd", "onSeriesDelete", "onEpisodeFileDelete", "onEpisodeFileDeleteForUpgrade", "onHealthIssue", "includeHealthWarnings", "onHealthRestored", "onApplicationUpdate", "onManualInteractionRequired", "supportsOnGrab", "supportsOnDownload", "supportsOnUpgrade", "supportsOnImportComplete", "supportsOnRename", "supportsOnSeriesAdd", "supportsOnSeriesDelete", "supportsOnEpisodeFileDelete", "supportsOnEpisodeFileDeleteForUpgrade", "supportsOnHealthIssue", "supportsOnHealthRestored", "supportsOnApplicationUpdate", "supportsOnManualInteractionRequired", "testCommand"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "onImportComplete": obj.get("onImportComplete"),
            "onRename": obj.get("onRename"),
            "onSeriesAdd": obj.get("onSeriesAdd"),
            "onSeriesDelete": obj.get("onSeriesDelete"),
            "onEpisodeFileDelete": obj.get("onEpisodeFileDelete"),
            "onEpisodeFileDeleteForUpgrade": obj.get("onEpisodeFileDeleteForUpgrade"),
            ...
            "supportsOnImportComplete": obj.get("supportsOnImportComplete"),
            "supportsOnRename": obj.get("supportsOnRename"),
            "supportsOnSeriesAdd": obj.get("supportsOnSeriesAdd"),
            "supportsOnSeriesDelete": obj.get("supportsOnSeriesDelete"),
            "supportsOnEpisodeFileDelete": obj.get("supportsOnEpisodeFileDelete"),
            "supportsOnEpisodeFileDeleteForUpgrade": obj.get("supportsOnEpisodeFileDeleteForUpgrade"),
