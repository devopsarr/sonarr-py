...
class MetadataResource(BaseModel):
    ...
    presets: Optional[List[MetadataResource]] = None
    enable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "enable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "presets": [MetadataResource.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None,
            "enable": obj.get("enable")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
MetadataResource.model_rebuild(raise_errors=False)
