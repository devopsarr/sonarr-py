...
class IndexerResource(BaseModel):
    ...
    season_search_maximum_single_episode_age: Optional[StrictInt] = Field(default=None, alias="seasonSearchMaximumSingleEpisodeAge")
    download_client_id: Optional[StrictInt] = Field(default=None, alias="downloadClientId")
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "enableRss", "enableAutomaticSearch", "enableInteractiveSearch", "supportsRss", "supportsSearch", "protocol", "priority", "seasonSearchMaximumSingleEpisodeAge", "downloadClientId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seasonSearchMaximumSingleEpisodeAge": obj.get("seasonSearchMaximumSingleEpisodeAge"),
