...
class AddSeriesOptions(BaseModel):
    ...
    search_for_cutoff_unmet_episodes: Optional[StrictBool] = Field(default=None, alias="searchForCutoffUnmetEpisodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchForCutoffUnmetEpisodes": obj.get("searchForCutoffUnmetEpisodes")
        })
        return _obj
