...
class MonitoringOptions(BaseModel):
    ...
    __properties = ["ignoreEpisodesWithFiles", "ignoreEpisodesWithoutFiles", "monitor"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonitoringOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonitoringOptions:
        """Create an instance of MonitoringOptions from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MonitoringOptions.parse_obj(obj)

        _obj = MonitoringOptions.parse_obj({
