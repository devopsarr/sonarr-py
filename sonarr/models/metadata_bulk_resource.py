...
class MetadataBulkResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetadataBulkResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetadataBulkResource:
        """Create an instance of MetadataBulkResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MetadataBulkResource.parse_obj(obj)

        _obj = MetadataBulkResource.parse_obj({
            "ids": obj.get("ids"),
            "tags": obj.get("tags"),
