...
class HistoryResource(BaseModel):
    ...
    event_type: Optional[EpisodeHistoryEventType]
    data: Optional[Dict]
    episode: Optional[EpisodeResource]
    series: Optional[SeriesResource]
    __properties = ["id", "episodeId", "seriesId", "sourceTitle", "languages", "quality", "customFormats", "customFormatScore", "qualityCutoffNotMet", "date", "downloadId", "eventType", "data", "episode", "series"]
