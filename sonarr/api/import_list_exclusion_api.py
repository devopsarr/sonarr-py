...
class ImportListExclusionApi(object):
    ...
    def create_import_list_exclusion_with_http_info(self, import_list_exclusion_resource : Optional[ImportListExclusionResource] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ImportListExclusionResource, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['import_list_exclusion_resource']:
            _body_params = _params['import_list_exclusion_resource']
        ...
        return self.api_client.call_api(
            '/api/v3/importlistexclusion', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def delete_import_list_exclusion_with_http_info(self, id : StrictInt, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/importlistexclusion/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_import_list_exclusion_by_id_with_http_info(self, id : StrictInt, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/importlistexclusion/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def list_import_list_exclusion_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[ImportListExclusionResource], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            '/api/v3/importlistexclusion', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def update_import_list_exclusion_with_http_info(self, id : StrictStr, import_list_exclusion_resource : Optional[ImportListExclusionResource] = None, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/importlistexclusion/{id}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
