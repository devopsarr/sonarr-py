...
class NotificationApi(object):
    ...
    @validate_arguments
    def delete_notification_bulk(self, notification_bulk_resource : Optional[NotificationBulkResource] = None, **kwargs) -> None:  # noqa: E501
        """delete_notification_bulk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_notification_bulk(notification_bulk_resource, async_req=True)
        >>> result = thread.get()

        :param notification_bulk_resource:
        :type notification_bulk_resource: NotificationBulkResource
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_notification_bulk_with_http_info(notification_bulk_resource, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_notification_bulk_with_http_info(self, notification_bulk_resource : Optional[NotificationBulkResource] = None, **kwargs):  # noqa: E501
        """delete_notification_bulk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_notification_bulk_with_http_info(notification_bulk_resource, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_notification_bulk" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['notification_bulk_resource']:
            _body_params = _params['notification_bulk_resource']
        ...
        return self.api_client.call_api(
            '/api/v3/notification/bulk', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def put_notification_bulk(self, notification_bulk_resource : Optional[NotificationBulkResource] = None, **kwargs) -> NotificationResource:  # noqa: E501
        """put_notification_bulk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_notification_bulk(notification_bulk_resource, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_notification_bulk_with_http_info(notification_bulk_resource, **kwargs)  # noqa: E501

    @validate_arguments
    def put_notification_bulk_with_http_info(self, notification_bulk_resource : Optional[NotificationBulkResource] = None, **kwargs):  # noqa: E501
        """put_notification_bulk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_notification_bulk_with_http_info(notification_bulk_resource, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method put_notification_bulk" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
