...
class SeriesImportApi(object):
    ...
    def create_series_import(self, series_resource : Optional[conlist(SeriesResource)] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.create_series_import(series_resource, async_req=True)
        >>> result = thread.get()
    ...
    def create_series_import_with_http_info(self, series_resource : Optional[conlist(SeriesResource)] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_series_import_with_http_info(series_resource, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_series_import" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
