...
class RootFolderApi(object):
    ...
    def create_root_folder_with_http_info(self, root_folder_resource : Optional[RootFolderResource] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RootFolderResource, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['root_folder_resource']:
            _body_params = _params['root_folder_resource']
    ...
    def list_root_folder_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[RootFolderResource], status_code(int), headers(HTTPHeaderDict))
        """
