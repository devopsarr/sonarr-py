...
class ReleaseProfileApi(object):
    ...
    def create_release_profile_with_http_info(self, release_profile_resource : Optional[ReleaseProfileResource] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ReleaseProfileResource, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['release_profile_resource']:
            _body_params = _params['release_profile_resource']
    ...
    def delete_release_profile_with_http_info(self, id : StrictInt, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/releaseprofile/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def list_release_profile_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[ReleaseProfileResource], status_code(int), headers(HTTPHeaderDict))
        """
