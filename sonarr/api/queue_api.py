...
class QueueApi:
    ...
    def get_queue(
        ...
        include_unknown_series_items: Optional[StrictBool] = None,
    ...
    def _get_queue_serialize(
        ...
        if include_unknown_series_items is not None:
            ...
            _query_params.append(('includeUnknownSeriesItems', include_unknown_series_items))
