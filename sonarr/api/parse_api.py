...
class ParseApi:
    ...
    def get_parse(
        ...
        _param = self._get_parse_serialize(
            title=title,
            path=path,
    ...
    @validate_call
    def get_parse_without_preload_content(
        self,
        title: Optional[StrictStr] = None,
        path: Optional[StrictStr] = None,
        _request_timeout: Union[
