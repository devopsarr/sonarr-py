...
class IndexerConfigApi(object):
    ...
    def get_indexer_config_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IndexerConfigResource, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def update_indexer_config_with_http_info(self, id : StrictStr, indexer_config_resource : Optional[IndexerConfigResource] = None, **kwargs):  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['indexer_config_resource']:
            _body_params = _params['indexer_config_resource']
