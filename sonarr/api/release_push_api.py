...
class ReleasePushApi(object):
    ...
    @validate_arguments
    def create_release_push(self, release_resource : Optional[ReleaseResource] = None, **kwargs) -> List[ReleaseResource]:  # noqa: E501
