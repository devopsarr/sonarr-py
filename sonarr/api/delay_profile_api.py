...
class DelayProfileApi(object):
    ...
    def create_delay_profile_with_http_info(self, delay_profile_resource : Optional[DelayProfileResource] = None, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DelayProfileResource, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['delay_profile_resource']:
            _body_params = _params['delay_profile_resource']
    ...
    def list_delay_profile_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[DelayProfileResource], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def update_delay_profile_reorder_with_http_info(self, id : StrictInt, after : Optional[StrictInt] = None, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/delayprofile/reorder/{id}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
